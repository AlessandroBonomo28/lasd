...
template <typename Data>
void DictionaryContainer<Data>::Insert(const LinearContainer<Data>& l) 
{
...
template <typename Data>
void DictionaryContainer<Data>::Insert(LinearContainer<Data>&& l) 
{
    for(unsigned int i = 0; i <l.Size(); i++)
    {
        Insert(std::move(l[i]));
...
template <typename Data>
void DictionaryContainer<Data>::Remove(const LinearContainer<Data>& l) 
{
    for(unsigned int i = 0; i < l.Size(); i++)
    {
        Remove(l[i]);
