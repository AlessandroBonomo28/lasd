...
//Insert Copy
template <typename Data>
bool BST<Data>::Insert(const Data &dato) noexcept {
...
//Remove
template <typename Data>
bool BST<Data>::Remove(const Data &dato) noexcept {
    struct BST<Data>::NodeLnk*& pointer = FindPointerTo(root, dato);
    if(pointer!=nullptr)
    {
...
// cast statico che passa da costante a non costante
template <typename Data>
...
/* ************************************************************************ */
// ritorna il primo nodo contenente il dato ricercato. ritorna il puntatore al nodo
template <typename Data>
